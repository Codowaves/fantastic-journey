...
describe("error/edge-case paths", () => {
  describe("negative Kelvin (physically below absolute zero)", () => {
    it("kelvinToCelsius returns a value below -273.15 for negative Kelvin input", () => {
      // The function does not validate; it just subtracts. Locking that in:
      // negative Kelvin should produce a sub-absolute-zero Celsius without
      // throwing.
  ...
  describe("negative Celsius (below freezing / below absolute zero)", () => {
  ...
  describe("large values", () => {
    it("kelvinToCelsius handles very large Kelvin inputs without overflow", () => {
      // Surface of the Sun ~ 5778 K; core ~ 1.5e7 K. The function should not
      // throw and should return a finite, scaled result.
