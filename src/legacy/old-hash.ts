 ...
 *
 * @example
 * timingUnsafeCompare("secret", "secret"); // => true
 * timingUnsafeCompare("secret", "Secret"); // => false
 * timingUnsafeCompare("a", "ab");          // => false (length differs)
 */
 ...
 *
 * @example
 * // SHARED_KEY is not set
 * authenticate("anything"); // => false
 *
 * @example
 * process.env.SHARED_KEY = "topsecret";
 * authenticate("topsecret"); // => true
